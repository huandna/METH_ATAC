...
GENOME=./ref.fa
python ../get_genome.bed.py --input $GENOME --output ./chidian.bed
...
python ../pred_Human_chr.py --region ./Region.slide.chidian.input.txt --anno ../Female_mus_anno_5w.txt
...
#get bw
ln -s ./chidian.bed chrom.size
awk '{print $1"\t"$3}' chidian.bed > species_chrom_size.xls
